                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 5,),
                          Text(
                            "Flutter is a popular open-source mobile application development"
                                " framework created by Google."
                                " It allows developers to build high-performance,"
                                " natively compiled applications for mobile,"
                                " web, and desktop platforms using a single codebase.",
                            style: GoogleFonts.mavenPro(
                                textStyle: TextStyle(
                                    color: Colors.black,
                                    fontSize: 18,
